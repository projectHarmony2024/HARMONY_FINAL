...
void loop()
{
  ...
  if (Firebase.ready() && (millis() - dataMillis > 60000 || dataMillis == 0))
  {
    ...
    // We will create the document in the parent path "a0/<RTC DS3231 Timestamp>
    // a0 is the collection id, <RTC DS3231 Timestamp> is the document id in collection a0.

    String documentPath = "HARMONY_SENSORS/" + RTCcurrentDateTime();
