...
void setup()
{
    ...
    unsigned int y = 255;
    char initial = 'A';
    float pi = 3.14159; // Limited precision
    ...
    debugf("Octal: %o\n", y);                      // OUTPUT: Octal: 377 (may vary depending on board)
    ...
    debugf("Floating-point (limited precision): %.2f\n", pi); // OUTPUT: Floating-point (limited precision): 3.14 (may vary depending on board)
