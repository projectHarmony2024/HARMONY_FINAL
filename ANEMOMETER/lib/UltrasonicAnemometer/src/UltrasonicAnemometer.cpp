...
UltrasonicAnemometer::UltrasonicAnemometer(uint8_t roPin, uint8_t diPin, uint8_t dePin, uint8_t rePin)
    : ultrasonicAnemometer(roPin, diPin, false), roPin(roPin), diPin(diPin), dePin(dePin), rePin(rePin)
{
    totalWindSpeed_ms = 0;
